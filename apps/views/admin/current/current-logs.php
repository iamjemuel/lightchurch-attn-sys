...
<div class="container-fluid">
	<div class="card">
		<div class="content">
			<form action="<?php echo $url;?>admin/current-logs/" method="GET" id="search">	
				<div class="row">
					<div class="col-lg-4 col-md-4">
						<small><b>TODAY</b></small>
						<h3><?php echo date('F j, Y', strtotime(date('Y-m-d'))); ?></h3>
					</div>
					<div class="col-lg-4 col-md-4">
					...
					<div class="dropdown pull-right">
						...
						<span class="caret"></span></button>
							<ul class="dropdown-menu">
						    	<li><a href="#" onclick="helper.Print(0, 'current')">Count only</a></li>
						    	<li><a href="#" onclick="helper.Print(1, 'current')">Count and Names</a></li>
						  	</ul>
					</div>
				</div>
			</div>
