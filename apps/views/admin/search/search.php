<?php 
include('apps/controllers/search/search.controller.php');
?>

<div class="container-fluid">
	<div class="card">
		<div class="content">
			<form action="<?php echo $url;?>admin/search/" method="GET" id="search">	
				<div class="row">
					...
					<div class="dropdown pull-right">
						...
						<span class="caret"></span></button>
							<ul class="dropdown-menu">
						    	<li><a href="#" onclick="helper.Print(0)">Count only</a></li>
						    	<li><a href="#" onclick="helper.Print(1)">Count and Names</a></li>
						  	</ul>
					</div>
				</div>
			</div>
